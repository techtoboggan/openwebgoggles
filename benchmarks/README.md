...
| 4 | `04_security_findings_qa.sh` | `item-triage` | Tabbed item review | Dependency / config review |
...
- **04** — Custom app (item-triage), complex data shape, multi-item tabbed UI, reviewer annotation, bulk submit action
